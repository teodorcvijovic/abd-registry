...
public class RegisterTest {
    ...
    public void sequential() {
        ...
        Register<Integer> copy1 = manager.newRegister("reg1", true);
        Register<Integer> copy2 = manager.newRegister("reg1");
        Register<Integer> copy3 = manager.newRegister("reg1");
    ...
    public void concurrent() throws ExecutionException, InterruptedException {
        ...
        Manager manager = new Manager();
        Register<Integer> copy1 = manager.newRegister("reg2", true);
        Register<Integer> copy2 = manager.newRegister("reg2");
        Register<Integer> copy3 = manager.newRegister("reg2");
